"""
Django settings for curtis_ent_test_app_223 project.
...
ROOT_URLCONF = 'curtis_ent_test_app_223.urls'
...
WSGI_APPLICATION = 'curtis_ent_test_app_223.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "curtis_ent_test_app_223 API",
    "DESCRIPTION": "API documentation for curtis_ent_test_app_223 App",
    "VERSION": "v1",
}
